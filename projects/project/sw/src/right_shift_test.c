...
// void vrsi_vi(register int* vd,int imm,register int* vs2){
//     asm volatile( ".insn i 0x57, 0x3, 0x51, %0, %1, %2": :"r"(vd), "i"(imm), "r"(vs2) );
// }
...
void vle_align(register int* vd, register int* vs1, int align){
...
int main() {
    ...
    */
    int8_t* addr_ptr = p_Input + 14;
    
    // vle_align(reg_vx1, (int*)addr_ptr, 8);
    // VLE_ALIGN(reg_vx8, addr_ptr, 8);
    // uintptr_t addr = (uintptr_t)addr_ptr;
    VLE_ALIGN(reg_vx1, (int*)addr_ptr, 8);
    // vrsi_vi(reg_vx1, (int)addr, reg_vx1);
    // VRSI_VI(reg_vx1, 1, reg_vx1);
    // switch (addr%8)
    // {
    // case 1:
    //     vrsi_vi(reg_vx1, reg_vx1, reg_vx1);
    //     break;
    // case 2:
    //     vrsi_vi(reg_vx1, reg_vx2, reg_vx1);
    //     break;
    // case 3:
    //     vrsi_vi(reg_vx1, reg_vx3, reg_vx1);
    //     break;
    // case 4:
    //     vrsi_vi(reg_vx1, reg_vx4, reg_vx1);
    //     break;
    // default:
    //     break;
    // }
    //vrsi_vi(reg_vx2, reg_vx2, reg_vx1);
